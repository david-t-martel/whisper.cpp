...
int main(int argc, char **argv)
{
    ...
    svr.Post(sparams.request_path + sparams.inference_path, [&](const Request &req, Response &res)
        ...
        // run the inference
        {
            ...
            whisper_print_user_data user_data = { &params, &pcmf32s, 0 };            // this callback is called on each new segment
            if (params.print_realtime) {
                // TODO: Callbacks not available in current API version
            ...
            }            // examples for abort mechanism - disabled for current API version
            // NOTE: Callback functionality not available in current whisper.h API
            // Skipping encoder_begin_callback and abort_callback setup
